 ...
 */
export function generatePassword(minLength, maxLength, useUppercase, useLowercase, useNumbers, useSymbols, customSymbols) {
...
export function generatePasswordFromRandom(minLength, maxLength, useUppercase, useLowercase, useNumbers, useSymbols, customSymbols, randomFn) {
 ...
 */
export function generatePasswordSecure(minLength, maxLength, useUppercase, useLowercase, useNumbers, useSymbols, customSymbols) {
